...
def get_schema_description() -> dict:
    ...
    return {
        ...
        "candidates": {
            "description": "Candidate strategy slots (up to 6 simultaneous experiments)",
            "columns": {
                "slot": "Slot number (1-6)",
                "strategy_version": "Version identifier for this candidate",
                "code_hash": "Hash of the strategy code",
                "description": "What the candidate strategy does",
                "backtest_summary": "JSON backtest results",
                "status": "running, promoted, canceled",
                "created_at": "When the candidate was created",
                "resolved_at": "When the candidate was promoted or canceled",
            },
        },
        "candidate_trades": {
            "description": "Completed trades from candidate strategies (separate from fund trades)",
            "columns": {
                "candidate_slot": "Which candidate slot (1-6)",
                "symbol": "Trading pair",
                "side": "'long' (system is long-only)",
                "qty": "Quantity traded",
                "entry_price": "Entry fill price",
        ...
        "candidate_signals": {
            "description": "Signals generated by candidate strategies",
            "columns": {
                "candidate_slot": "Which candidate slot (1-6)",
                "symbol": "Trading pair",
                "action": "BUY, SELL, CLOSE, or MODIFY",
        ...
        "candidate_daily_performance": {
            "description": "Daily portfolio snapshots for candidate strategies",
            "columns": {
                "candidate_slot": "Which candidate slot (1-6)",
                "date": "Date (YYYY-MM-DD)",
                "portfolio_value": "Total portfolio value",
